...
Singleton {
    ...
    property QtObject apps: QtObject {
        ...
        property string networkEthernet: "XDG_CURRENT_DESKTOP=GNOME gnome-control-center wifi"
        property string settings: "XDG_CURRENT_DESKTOP=GNOME gnome-control-center wifi"
