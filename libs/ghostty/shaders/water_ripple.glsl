...
const float FRONT_SPEED       = 0.283;  // UV/s the disturbance front expands at (≈ OMEGA/WAVENUMBER); halved area → ÷√2
const float FRONT_WIDTH       = 0.09;   // softness of the expanding front edge
const float FALLOFF_SCALE     = 3.0;    // spatial falloff: higher = rings shrink faster outward
...
// --- Surface rendering ---
const float REFRACTION        = 0.05;   // texture displacement from height gradient (legibility!)
